        ...
        switch (caseImage.id) {
          case 'peepfeed':
            setModal(caseImage,
              ...
              '#E87042',
              'Mobile web app',
              ['SPA', 'API & JSON Fetch', 'ES6 koncepter', 'Moduler & SoC', 'OOP'], 'En mobilbaseret film-app, hvor man bl.a. kan følge skuespillere og instruktører og få genereret relaterede filmforslag (3. semester)',
              'src/cases/peepfeed/',
          ...
          case 'klosterbryggeriet':
            setModal(caseImage,
              ...
              '#C19945',
              'Oplevelsessite',
              ['SEO', 'Produktbranding', 'Ikonproduktion', 'Fotoproduktion', 'Mobile-First'], 'Et oplevelsessite som skulle hjælpe ølproducenten Klosterbryggeriet med at øge julesalget (1. semester)',
          ...
          case 'city-escape':
            setModal(caseImage,
              ...
              '#C99D2B',
              'Virksomhedscase',
              ['Booking system', 'Modaler', 'Videoproduktion', 'SVG infografik', 'Typewriter-effect'], 'En virksomhedscase som skulle hjælpe Escape Game-virksomheden City Escape med konceptforklaring og hjælp til et bookingsystem (2. semester)',
